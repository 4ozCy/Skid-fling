...
-- Create a Frame to contain the button and make it draggable
...
-- Create a TextButton for the 'SkidFling' function
local button = Instance.new("TextButton")
button.Parent = frame
button.Size = UDim2.new(0, 200, 0, 50)
button.Position = UDim2.new(0, 0, 0, 25) -- Position inside the frame
button.Text = "Skid Fling"

-- Function to handle button activation
local function onButtonActivated()
    print("Activating SkidFling for all targets")
...
-- Connect the button to the function for both click and touch input
button.MouseButton1Click:Connect(onButtonActivated)
button.TouchTap:Connect(onButtonActivated)
